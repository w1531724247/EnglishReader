...
#define isRegularHorizontalClass ([UIApplication sharedApplication].delegate.window.rootViewController.traitCollection.horizontalSizeClass == UIUserInterfaceSizeClassRegular)
